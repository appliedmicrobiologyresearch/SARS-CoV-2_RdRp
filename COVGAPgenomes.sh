...
####now aligning with the reference####
...
#mkdir alignments/
mafft --thread 12 --reorder --keeplength --mapout --kimura 1 --addfragments pre-process/single_genomes/"$sample_id".fa --auto /scicore/home/egliadr/GROUP/projects/COVID-19/Illumina/Softwares/dependencies/referenceNC.fasta > alignments/"$sample_id".alignment
